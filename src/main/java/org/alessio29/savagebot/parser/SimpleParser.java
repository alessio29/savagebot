...
public class SimpleParser {
	...
	private static final Pattern d66RollPattern = Pattern.compile("^[dD����]66$");
	...
	private static final Pattern basicAndExplodingPattern = Pattern.compile("^[0-9]*[dD����][0-9]+!?$");
	private static final Pattern fudgePattern = Pattern.compile("^[0-9]*[dD����][Ff��]?$");
	private static final Pattern rollAndKeepPattern = Pattern.compile("^[0-9]*[dD����][0-9]+[kK��][0-9]+$"); 
	private static final Pattern rollAndKeepLowestPattern = Pattern.compile("^[0-9]*[dD����][0-9]+(kl|KL|�|�)[0-9]+$");
	private static final Pattern savageWorldsPattern = Pattern.compile("^[0-9]*[sS��](4|6|8|10|12)+$");
	private static final Pattern savageWorldsPatternWithCustomWildDiePattern = Pattern.compile("^[0-9]*[sS��](4|6|8|10|12)[wW��](4|6|8|10|12)+$");
	private static final Pattern ladyBlackbirdPattern = Pattern.compile("^[0-9]*[dD����][0-9]+[sS��][0-9]+$");
	...
	private static DiceRollResult parseDiceCode(String roll) throws ParseErrorException, WrongDieCodeException {
		...
		if (fudgeMatcher .find()) {
			...
			if (pos == -1) {
				pos = roll.trim().toLowerCase().indexOf("��");
			}
			if (pos == -1) {
				pos = roll.trim().toLowerCase().indexOf("��");
			}			
