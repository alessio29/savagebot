...
public class TestR2Interpreter {
    ...
    public void testSavageWorldsRolls() {
        ...
        expect(
                "3s6+2: [wild: [6+6+6+6+4=28]; 1; 2; 5] + 2 = **4**, **7**, **30**",
                "3s6+2"
        );
    }
    ...
    public void testRepeatedRolls() {
        ...
        expect(
                "10x3s6+2: \n" +
                        "1: 3s6+2: [wild: [6+6+6+6+4=28]; 1; 2; 5] + 2 = **4**, **7**, **30**\n" +
                        "2: 3s6+2: [wild: [6+3=9]; 3; 4; [6+6+6+5=23]] + 2 = **6**, **11**, **25**\n" +
                        "3: 3s6+2: [wild: 2; 4; 5; [6+3=9]] + 2 = **6**, **7**, **11**\n" +
                        "4: 3s6+2: [wild: 5; 1; 3; [6+3=9]] + 2 = **5**, **7**, **11**\n" +
                        "5: 3s6+2: [wild: [6+6+6+6+6+3=33]; 1; 4; 5] + 2 = **6**, **7**, **35**\n" +
                        "6: 3s6+2: [wild: 4; 3; 4; [6+5=11]] + 2 = **6**, **6**, **13**\n" +
                        "7: 3s6+2: [wild: 5; 2; 3; [6+3=9]] + 2 = **5**, **7**, **11**\n" +
                        "8: 3s6+2: [wild: 5; 4; 5; 5] + 2 = **7**, **7**, **7**\n" +
                        "9: 3s6+2: [wild: 3; 1; 2; 4] + 2 = **4**, **5**, **6**\n" +
                        "10: 3s6+2: [wild: 5; 1; 4; 5] + 2 = **6**, **7**, **7**",
                "10x3s6+2"
        );
    }
    ...
    public void testSuccessOrFail() {
        ...
        expect(
                "12d10f1s7: [1:red_circle:, 9:white_check_mark:, 10:white_check_mark:, 8:white_check_mark:, " +
                        "6, 4, 2, 2, 10:white_check_mark:, 5, 8:white_check_mark:, 8:white_check_mark:] = **5**",
                "12d10f1s7"
        );
        expect(
                "28d6!s10f1: [1:red_circle:, 5, 2, [6+6+6+6+4=28]:white_check_mark:, 4, 3, " +
                        "[6+6+6+5=23]:white_check_mark:, [6+3=9], 5, 4, [6+3=9], 2, 1:red_circle:, 3, [6+3=9], " +
                        "5, 4, 5, 1:red_circle:, [6+6+6+6+6+3=33]:white_check_mark:, 3, 4, " +
                        "[6+5=11]:white_check_mark:, 4, 3, 2, [6+3=9], 5] = **1**",
                "28d6!s10f1"
        );
    }
    ...
    public void testBoundTo() {
        ...
        expect(
                "5x(d10!+d8!+d6!)[8:10+8+6]: \n" +
                        ...
                        "2: (d10!+d8!+d6!)[8:10+8+6]: {(8 + 6 + [6+6+4=16]) = 30=>24} = **24**\n" +
                        "3: (d10!+d8!+d6!)[8:10+8+6]: {([10+5=15] + 3 + [6+6+5=17]) = 35=>24} = **24**\n" +
                        "4: (d10!+d8!+d6!)[8:10+8+6]: {(6 + [8+8+1=17] + [6+3=9]) = 32=>24} = **24**\n" +
