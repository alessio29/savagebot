...
public class TestR2Interpreter {
    ...
    public void testGenericRolls() {
        ...
        expect(
                "10d6!: 1 + 5 + 2 + 4x6+4=28 + 4 + 3 + 3x6+5=23 + 9 + 5 + 4 = **84**",
                "10d6!"
        );
        expect(
                "4d6k3: ~~1~~ + 2 + 5 + 6 = **13**",
    ...
    public void testSavageWorldsRolls() {
        ...
        expect(
                "3s6+2: [1; 2; 5; w4x6+4=28] + 2 = **4**, **7**, **30**",
                "3s6+2"
        );
    }
    ...
    public void testRepeatedRolls() {
        ...
        expect(
                "10x3s6+2: \n" +
                        "1: 3s6+2: [1; 2; 5; w4x6+4=28] + 2 = **4**, **7**, **30**\n" +
                        "2: 3s6+2: [3; 4; 3x6+5=23; w9] + 2 = **6**, **11**, **25**\n" +
                        "3: 3s6+2: [4; 5; 9; w2] + 2 = **6**, **7**, **11**\n" +
                        "4: 3s6+2: [1; 3; 9; w5] + 2 = **5**, **7**, **11**\n" +
                        "5: 3s6+2: [1; 4; 5; w5x6+3=33] + 2 = **6**, **7**, **35**\n" +
    ...
    public void testSuccessOrFail() {
        ...
        expect(
                "28d6!s10f1: [1:red_circle:, 5, 2, 4x6+4=28:white_check_mark:, 4, 3, 3x6+5=23:white_check_mark:, " +
                        "9, 5, 4, 9, 2, 1:red_circle:, 3, 9, 5, 4, 5, 1:red_circle:, 5x6+3=33:white_check_mark:, " +
                        "3, 4, 11:white_check_mark:, 4, 3, 2, 9, 5] = **1**",
                "28d6!s10f1"
        );
    }
    ...
    public void testBoundTo() {
        ...
        expect(
                "5x(d10!+d8!+d6!)[8:10+8+6]: \n" +
                        ...
                        "2: (d10!+d8!+d6!)[8:10+8+6]: {(8 + 6 + 2x6+4=16) = 30=>24} = **24**\n" +
                        "3: (d10!+d8!+d6!)[8:10+8+6]: {(15 + 3 + 2x6+5=17) = 35=>24} = **24**\n" +
                        "4: (d10!+d8!+d6!)[8:10+8+6]: {(6 + 2x8+1=17 + 9) = 32=>24} = **24**\n" +
