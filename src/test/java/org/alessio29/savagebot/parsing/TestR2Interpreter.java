...
public class TestR2Interpreter {
    ...
    public void testGygaxRangeRoll() {
        ...
        expect("40--240: [4d6×10] (1 + 5 + 2 + 6) × 10 = **140**", "40--240");
        expect("30--300: [3d10×10] (1 + 9 + 10) × 10 = **200**", "30--300");
        expect("60--600: [6d10×10] (1 + 9 + 10 + 8 + 6 + 4) × 10 = **380**", "60--600");
        expect("1200--7200: [12d6×100] (1 + 5 + 2 + 6 + 6 + 6 + 6 + 4 + 4 + 3 + 6 + 6) × 100 = **5500**", "1200--7200");
    }
